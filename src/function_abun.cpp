...
double h1_cpp(double pi1, double pi2, double m1, double m2, double n1, double n2,int s){
...
double h1_hat_cpp(NumericVector pi1, NumericVector pi2, NumericVector xi1, NumericVector xi2, int m1, int m2, int n1, int n2){
  ...
  if(m1>0){
    ...
    //    double sumsh_p = 0;
    for(int i=0; i < pi1_tmp.size(); i++){
      sumsh = sumsh +  h1_cpp(pi1_tmp[i],pi2_tmp[i],m1,m2,n1,n2,0)/(1-pow(1-pi1_tmp[i], n1))/(1-pow(1-pi2_tmp[i], n2));
    ...
    double sumx0 = 0;
    for(int i=0; i < pi1_tmp.size(); i++){
      sumx0 = sumx0 +  h1_cpp(0,pi2_tmp[i],m1,m2,n1,n2,0)/(1-pow(1-pi2_tmp[i], n2));
    }
    ...
    double sumy0 = 0;
    for(int i=0; i < pi1_tmp.size(); i++){
      sumy0 = sumy0 +  h1_cpp(pi1_tmp[i],0,m1,m2,n1,n2,0)/(1-pow(1-pi1_tmp[i], n1));
    }
